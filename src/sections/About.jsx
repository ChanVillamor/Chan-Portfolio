...
const About = () => {
  return (
    <section id="about" className="w-full flex flex-col justify-center items-start container pt-16 pb-16 min-h-screen">
      <motion.div 
      ...
      >
        <div className="flex flex-col gap-12 lg:flex-row lg:gap-20">
          <div className='text-poppins'>
            <h1 className="text-dirty-white text-2xl md:text-4xl lg:text-4xl font-bold tracking-wider">ABOUT ME</h1>
            <span className="block bg-green-950 rounded w-[139px] h-[4px] md:w-[265px] lg:w-[265px] mt-1"></span>
            <p className="text-gray text-base font-extralight tracking-wider mt-1">chanmichaelespinavillamor@gmail.com</p>
        ...
        <div className='flex flex-col'>
          <h1 className="text-dirty-white text-2xl md:text-4xl lg:text-4xl font-bold tracking-wider">INTEREST</h1>
