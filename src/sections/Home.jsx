...
const Home = () => {
  return (
    <section id="home" className='w-full flex flex-col justify-center items-start min-h-screen container pt-20'>
      <motion.div 
        className="flex flex-col gap-10 text-dirty-white font-poppins md:gap-14 lg:gap-16"
      ...
      >
        ...
        <ul className="relative flex justify-start gap-5 md:gap-8 lg:gap-8 pl-1 lg:top-12">
